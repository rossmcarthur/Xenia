...
user6 = User.create!(email: 'beth123@gmail.com', password: 'whatever', first_name: 'Beth', last_name: 'Hamilton', image: "https://s3.amazonaws.com/xenia-seeds/pexels-photo-712521.jpeg")
user7 = User.create!(email: 'greta123@gmail.com', password: 'whatever', first_name: 'Greta', last_name: 'Timmons', image: "https://s3.amazonaws.com/xenia-seeds/pexels-photo-432722.jpeg")
user8 = User.create!(email: 'jim123@gmail.com', password: 'whatever', first_name: 'Jim', last_name: 'Garreth', image: "https://s3.amazonaws.com/xenia-seeds/pexels-photo-428339.jpeg")
user9 = User.create!(email: 'mary123@gmail.com', password: 'whatever', first_name: 'Mary', last_name: 'Shin', image: "https://s3.amazonaws.com/xenia-seeds/pexels-photo-415829.jpeg")
user10 = User.create!(email: 'stella123@gmail.com', password: 'whatever', first_name: 'Stella', last_name: 'Taylor', image: "https://s3.amazonaws.com/xenia-seeds/pexels-photo-372042.jpeg")
user11 = User.create!(email: 'ted123@gmail.com', password: 'whatever', first_name: 'Ted', last_name: 'Handler', image: "https://s3.amazonaws.com/xenia-seeds/pexels-photo-325682.jpeg")
user12 = User.create!(email: 'leah123@gmail.com', password: 'whatever', first_name: 'Leah', last_name: 'Abbot', image: "https://s3.amazonaws.com/xenia-seeds/pexels-photo-324658.jpeg")
user13 = User.create!(email: 'ashley123@gmail.com', password: 'whatever', first_name: 'Ashley', last_name: 'Lawler', image: "https://s3.amazonaws.com/xenia-seeds/pexels-photo-253758.jpeg")
user14 = User.create!(email: 'sean123@gmail.com', password: 'whatever', first_name: 'Sean', last_name: 'Teller', image: "https://s3.amazonaws.com/xenia-seeds/pexels-photo-173295.jpeg")
user15 = User.create!(email: 'obama123@gmail.com', password: 'whatever', first_name: 'Barack', last_name: 'Obama', image: "https://s3.amazonaws.com/xenia-seeds/man-person-suit-united-states-of-america.jpg")
user16 = User.create!(email: 'carl123@gmail.com', password: 'whatever', first_name: 'Carl', last_name: 'Holmes', image: "https://s3.amazonaws.com/xenia-seeds/male-97.jpg")
user17 = User.create!(email: 'fred123@gmail.com', password: 'whatever', first_name: 'Fred', last_name: 'Fredson', image: "https://s3.amazonaws.com/xenia-seeds/male-89.jpg")
user18 = User.create!(email: 'wendy123@gmail.com', password: 'whatever', first_name: 'Wendy', last_name: 'Williams', image: "https://s3.amazonaws.com/xenia-seeds/female-95.jpeg")
user19 = User.create!(email: 'sandra123@gmail.com', password: 'whatever', first_name: 'Sandra', last_name: 'Sellars', image: "https://s3.amazonaws.com/xenia-seeds/female-84.jpg")
user20 = User.create!(email: 'elise123@gmail.com', password: 'whatever', first_name: 'Elise', last_name: 'Bella', image: "https://s3.amazonaws.com/xenia-seeds/female-65.jpg")
user21 = User.create!(email: 'trish123@gmail.com', password: 'whatever', first_name: 'Trish', last_name: 'Maxwell', image: "https://s3.amazonaws.com/xenia-seeds/female-22.jpg")
